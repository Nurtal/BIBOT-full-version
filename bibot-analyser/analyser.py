...
##  - centralize functions that display informations as figures => [DONE]
...
def collect_meta_informations():
    """
    IN PROGRESS

    TODO:
        - provide list of pmid
    ...
    for pmid in test_pmid:
        informations = online_retrieval.get_meta_information(pmid)
        pmid_to_info[pmid] = informations
...
def main(argv):
    ...
    if(test_figure):
        ...
        #figure_generation.write_html_report(meta)
